...
ResultSet rs1 = statement.executeQuery("select sender_id,message from message1 where receiver_id = '" + emailid + "'");
%>  
<H1 align="center"> INBOX MESSAGES</H1>
 <TABLE border="1" class="t1">
           
            <% while(rs1.next()){ %>
            <tr>
                <TD class="msg">From:</TD><td> <%= rs1.getString(1) %></td></tr>
